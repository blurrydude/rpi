...
circuit = {
    ...
    "C1": {"id": "C1", "address": "shellyswitch25-8CAAB55F44D6", "relay":"0"}, #192.168.1.243 - Front Door Cam
...
mqttCommands = [
    MosquittoCommand("open bay one", "baydoorpi/commands", "0:1"),
    MosquittoCommand("close bay one", "baydoorpi/commands", "0:0"),
    MosquittoCommand("open bay 1", "baydoorpi/commands", "0:1"),
    MosquittoCommand("close bay 1", "baydoorpi/commands", "0:0"),
    MosquittoCommand("close bay two", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open bay two", "baydoorpi/commands", "1:1"),
    MosquittoCommand("close bay to", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open bay to", "baydoorpi/commands", "1:1"),
    MosquittoCommand("close bay 2", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open bay 2", "baydoorpi/commands", "1:1"),
    MosquittoCommand("open garage door one", "baydoorpi/commands", "0:1"),
    MosquittoCommand("close garage door one", "baydoorpi/commands", "0:0"),
    MosquittoCommand("open garage door 1", "baydoorpi/commands", "0:1"),
    MosquittoCommand("close garage door 1", "baydoorpi/commands", "0:0"),
    MosquittoCommand("close garage door two", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open garage door two", "baydoorpi/commands", "1:1"),
    MosquittoCommand("close garage door to", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open garage door to", "baydoorpi/commands", "1:1"),
    MosquittoCommand("close garage door 2", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open garage door 2", "baydoorpi/commands", "1:1"),
    MosquittoCommand("open garage door right", "baydoorpi/commands", "0:1"),
    MosquittoCommand("close garage door right", "baydoorpi/commands", "0:0"),
    MosquittoCommand("close garage door left", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open garage door left", "baydoorpi/commands", "1:1"),
    MosquittoCommand("close shop door", "baydoorpi/commands", "1:0"),
    MosquittoCommand("open shop door", "baydoorpi/commands", "1:1"),
