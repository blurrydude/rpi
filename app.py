...
mqttCommands = [
    ...
    MosquittoCommand("turn on bathroom", "shellies/shellyswitch25-8CAAB5561DDED/relay/0/command", "on"),
    MosquittoCommand(    "turn off bathroom", "shellies/shellyswitch25-8CAAB5561DDED/relay/0/command", "off"),
